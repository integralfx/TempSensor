...
// {
//     SendData(false, 0b1000 | (display_on << 2) | (cursor_on << 1) | cursor_blink);
// }

// void LCD_SetFunction(bool data_8bit, bool two_lines, bool font_10dots)
// {
//     SendData(false, 0b100000 | (data_8bit << 4) | (two_lines << 3) | (font_10dots << 2));
// }

// void LCD_MoveScreen(bool right)
// {
//     //SendData(false, 0b11000 | (right << 2));
//     SendData(false, right ? 0b11100 : 0b11000);
// }
...
//     SendData(false, 0b10000000 | address);
// }

// void LCD_WriteChar(char c)
// {
//     SendData(true, static_cast<uint8_t>(c));
// }
